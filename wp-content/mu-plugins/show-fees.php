            ...
            <div class="payment-two-div">
                <div class="div-header">
                    ...
                    <div class="div-header-img">
                        ...
                        <img class="div-header-img-two" src="<?php echo get_theme_file_uri('/images/oplaty/10.png'); ?>" alt="">
                    </div>
                </div>
                <div class="div-body pt">
                    <span>
                ...
                <div class="div-body">
                    ...
                    <p>w przypadku zgłoszonej nieobecności dziecka w przedszkolu (zgłoszenie przyjęte do godz. 8.00 w tym samym dniu) nie nalicza się opłaty żywieniowej za dni w których zostało zgłoszone</p> 
                </div>
                <div class="div-body">
                    <span>
                        <img src="<?php echo get_theme_file_uri('/images/oplaty/4.png'); ?>" alt="">
