...
function main_site_files(){
    ...
    if(strstr($_SERVER['SERVER_NAME'], 'krainaszczescia.local')){
        ...
        wp_enqueue_script('main-site-js', get_theme_file_uri('/bundled-assets/scripts.8033d6da0fa5d0941114.js'), NULL, '1.0', true);
        wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.8033d6da0fa5d0941114.css'));
    }
