...
<section class="main-site">
    <div class="main-header">
        <h1 class="logo" title="Strona główna Przedszkola i Żłobka Kraina Szczęścia">
            <a href="/">
                <img src="<?php echo get_theme_file_uri('/images/logo.png'); ?>" alt="Strona główna Przedszkola i Żłobka Kraina Szczęścia">
            </a>
        </h1>
    </div>
    <div class="main-div">
        <div class="main-div-img">
            <a href="https://zlobek.krainaszczescia.edu.pl/">
    ...
    <div class="main-div">
        <div class="main-div-img">  
            <a href="https://przedszkole.krainaszczescia.edu.pl/">
