        ...
        <div class="payment-position">
            ...
            <div class="payment-one" id="three">
                ...
                <div class="payment-h4">
                    ...
                    <h4>prowadzone są zajęcia dodatkowe takie jak:</h4> 
                </div>
                ...
                <div class="payment-h4">
                    ...
                    <h4>oferujemy liczne atrakcje i wycieczki fakultatywne, wycieczki do kin i teatru, audycje muzyczne, warsztaty tematyczne</h4> 
                </div>
                <div class="payment-h4">
                    <span>
                        <img src="<?php echo get_theme_file_uri('/images/oplaty/4.png'); ?>" alt="">
                    </span>
                    <h4>opiekę logopedy, neurologopedy i zajęcia terapeutyczne</h4> 
                </div>
                <div class="payment-h4">
                    <span>
                        <img src="<?php echo get_theme_file_uri('/images/oplaty/4.png'); ?>" alt="">
