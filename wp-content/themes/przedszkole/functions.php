...
function kindergarten_files(){
    ...
    if(strstr($_SERVER['SERVER_NAME'], 'przedszkole.krainaszczescia.local')){
        ...
        wp_enqueue_script('main-kindergarten-js', get_theme_file_uri('/bundled-assets/scripts.9bdf57108527a54f7a43.js'), NULL, '1.0', true);
        wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.9bdf57108527a54f7a43.css'));
